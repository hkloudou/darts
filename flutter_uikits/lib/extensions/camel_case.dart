...
extension StringCamelCaseExtension on String {
  String get camelCase => CamelCase(this).camelCase;

  String get constantCase => CamelCase(this).constantCase;

  String get sentenceCase => CamelCase(this).sentenceCase;

  String get snakeCase => CamelCase(this).snakeCase;

  String get dotCase => CamelCase(this).dotCase;

  String get paramCase => CamelCase(this).paramCase;

  String get pathCase => CamelCase(this).pathCase;

  String get pascalCase => CamelCase(this).pascalCase;

  String get headerCase => CamelCase(this).headerCase;

  String get titleCase => CamelCase(this).titleCase;
}
